...
class UserCreationForm(forms.ModelForm):
	...
	password2= forms.CharField(label='Password confirmation', widget= forms.PasswordInput(attrs={'class': "form-group"}))
...
class UserLoginForm(forms.Form):
	query = forms.CharField(label='Email',widget=forms.TextInput(attrs={'class': "form-group"}))
